...
declare const car: ICar;
declare const car2: ICar;
declare const car3: ICar;
declare const motorbike: IMotorbike;
declare const motorbike2: IMotorbike;
declare const motorbike3: IMotorbike;
declare const autoStorage: IVehicleStorage<ICar>;
declare const bikeStorage: IVehicleStorage<IMotorbike>;
declare const AllStorage: IVehicleStorage<IVehicle>;
